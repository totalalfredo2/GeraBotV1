...
let str = `
*ミ💖 Que onda perro! ✨${name}✨, 𝙰𝚀𝚄𝙸 𝙴𝚂𝚃𝙰 𝙴𝙻 𝙼𝙴𝙽𝚄 𝙲𝙾𝙼𝙿𝙻𝙴𝚃𝙾 DE GERABOT-v1 💖彡*
...
`.trim()
conn.sendHydrated(m.chat, str, wm, pp, 'https://github.com/totalalfredo2/GeraBotV1', '𝙶𝙸𝚃𝙷𝚄𝙱', null, null, [
['💖 𝘿𝙤𝙣𝙖𝙧 | 𝘿𝙤𝙣𝙖𝙩𝙚', '.donar'],
